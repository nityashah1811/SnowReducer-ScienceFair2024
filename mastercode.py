...
def split_video(video_file, output_dir, segment_length, target_fps=300):
    ...
    #Go through the duration of the video and save 0.1 second segments of the video.
...
def snow_remover(path_to_video, video_name):
    ...
    os.makedirs("FinalOutputPngs", exist_ok=True)
    output_filename = "FinalOutputPngs/" + str(video_name) + "videoFinal.png"
    removed_pngs_folder = str(video_name) + 'videoOutputPngs'
...
#INTERATE THROUGH EACH VIDEO RUNNING THE SNOW_REMOVED FUNCTION ON EACH ONE
